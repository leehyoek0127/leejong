...
public class League_team_step2_Action {

	static League_team_step2_Action model = new League_team_step2_Action();

	public static League_team_step2_Action instance() {
		return model;
	}
