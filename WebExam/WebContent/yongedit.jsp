		...
		<section id="mainright">
			<div id="matList">
				<div class="container" id="formOutterWrapper">
					<center>
						  <div class="writeboardtitle" style="text-align: center; font-size: 50px; ">용병 수정<%out.println(id); %></div>
					</center>
						...
						<form name="yongjoin" id="materialForm" class="form" method="post" action="yongsignInsert.jsp?fn=2&yno=<%=index%>" role="form" autocomplete="off"><div class="form-group">
								...
								<div class="col-xs-4">
									<select name="y_b_branch" class=formInput>
										...
										<option value="안산 고진점">안산 고진점</option>
										<option value="서수원점">서수원점</option>
										<option value="일산점">일산점</option>
										<option value="대전 탄방점">대전 탄방점</option>
										<option value="동대전점">동대전점</option>
										<option value="부산 가야점">부산 가야점</option>
										<option value="울산 남구점">울산 남구점</option>
										<option value="창원점">창원점</option>
										<option value="전주 완산점">전주 완산점</option>
										<option value="울산 북구점">울산 북구점</option>
										<option value="GLOBAL ARENA(Japan)">GLOBAL ARENA(Japan)</option>
										<option value="부산 북구점">부산 북구점</option>
										<option value="Seogwipo. JEJU">Seogwipo. JEJU</option>
										<option value="가천대학교 운동장">가천대학교 운동장</option>
									</select>
								</div>
								<div class="col-xs-4">
