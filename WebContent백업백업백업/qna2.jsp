					...
					<form id="qnainsert" action="qnaInsert.jsp" method="post">
						...
						%>	<a>
							<tr>
								...
								<td class="thtitle">
									<a onClick="selectOne(<%=list.get(i).getqNo() %>); location.href='#popup<%=list.get(i).getqNo() %>'; "  class="button" id="listtt"><%=list.get(i).getqTitle() %></a><img src="img/lock2.png" class="secretimg">
									<a href="#popup<%=list.get(i).getqNo() %>">sdagsdag</a>
								</td>
