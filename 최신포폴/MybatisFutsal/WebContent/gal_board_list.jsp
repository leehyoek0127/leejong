					...
					<table class="table table-striped" style="width: 850px; float: left; margin-left:44px;">
						...
						<tbody>
							...
							<tr class="picli" style="font-size: 15px; font-family: -webkit-pictograph; text-align:center;">
								...
								<a href="boardDetail.bo?board_num=<%=articleList.get(i).getGB_NUM()%>&page=<%=nowPage%>"> <img src="boardUpload/<%=articleList.get(i).getGB_FILE()%>" class="Fileimg"></a><br>
								<a href="boardDetail.bo?board_num=<%=articleList.get(i).getGB_NUM()%>&page=<%=nowPage%>" style="font-size:20px;"> <%=articleList.get(i).getGB_SUBJECT()%></a><br>
