...
<%
	G_BoardBean article = (G_BoardBean) request.getAttribute("article");
					...
					<center>
						...
						<div class="container" id="formInnerWrapper">
							...
							<section id="commandList">
								<a href="galModifyForm.bo?GB_NUM=<%=article.getGB_NUM()%>"> [수정] </a> <a href="galDeleteForm.bo?GB_NUM=<%=article.getGB_NUM()%>&page=<%=nowPage%>"> [삭제] </a> <a href="boardList.bo?page=<%=nowPage%>">[목록]</a>&nbsp;&nbsp;
							</section>
					</center>
