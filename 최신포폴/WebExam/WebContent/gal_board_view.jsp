						...
						<div class="container" id="formInnerWrapper">
							...
							<table>
								<tr style="padding: 15px 15px 22px 15px;border-top: 2px solid #2c3c57;">
									...
									<td class="viewform" colspan="2" style="font-size:55px;padding-left: 40px;"><%=article.getG_b_subject()%></td>
								</tr>
								<tr style="padding: 15px 15px 22px 15px; border-bottom: 1px solid #d5d8dd;padding-left: 40px;">
									<td class="viewsubject"><%=article.getG_b_date() %></td>
									<td class="viewform"><%=article.getId()%></td>
								</tr>
								<tr>
									...
									<td class="viewform" style="padding-top:50px;">
										...
										<img alt="" src="boardUpload/<%=article.getG_b_file()%>"  class="imgst">
										</a>
										<%
											}
										%>
							...
							<section id="commandList">
								<a href="galModifyForm.bo?GB_NUM=<%=article.getG_b_no()%>"> [수정] </a> <a href="galDeleteForm.bo?GB_NUM=<%=article.getG_b_no()%>&page=<%=nowPage%>"> [삭제] </a> <a href="boardList.bo?page=<%=nowPage%>">[목록]</a>&nbsp;&nbsp;
							</section>
					</center>
