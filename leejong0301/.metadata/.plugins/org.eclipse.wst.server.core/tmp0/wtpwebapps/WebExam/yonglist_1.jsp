...
<body>
	...
	<section id="main">
		<section id="mainright">
			<div id="matList">
				<div class="writeboardtitle" style="margin-top: 5px; font-size: 50px; line-height: 80px; text-align: center;">용 병 등 록</div>
				<div class="cbox">
					<table class="table table-striped" style="font-size: 16px;">
						...
						<tbody>
							...
							<tr>
								...
								<td class="thdate2" style="text-align: center;"><a onClick="selectOne(<%=yong.get(i).getYno()%>,'<%=yong.get(i).getYid()%>'); " class="button" id="listtt"> <%=yong.get(i).getY_b_schedule()%></a></td>
