				...
				<div class="container" id="formOutterWrapper">
					...
					<center>
						<table class="resulttable">
							...
							<tr>
								<td class="td1style">예약하신 지점</td>
								<td><%=branch_name%></td>
							</tr>
							<tr>
								<td class="td1style">예약하신 구장</td>
								<td><%=ground_name%></td>
							</tr>
							<tr>
							...
							<tr>
								<td class="td1style">결제번호</td>
								<td><%=res_no%></td>
							</tr>
							<tr>
								<td class="td1style">결제금액</td>
								<td><%=payment_charge%></td>
							</tr>
						</table>
					</center>
					<hr />
					...
					<center>
						<input type="button" value="메인으로" class="signbutton signbutton5"
							onClick="script: location.href='branchlist.do?command=branchlistview'"
							style="width: 250px;">
					</center>
