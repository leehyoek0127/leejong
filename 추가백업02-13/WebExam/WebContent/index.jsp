...
var positions = [
    {
    	content: '<div class="wrap">' + 
			     ...
			     '    </div>' +    
			     '</div>', 
		content2: '<div class="close" onclick="closeOverlay()" title="닫기">dd</div>',
        title: '카카오', 
...
for (var i = 0; i < positions.length; i ++) {
    ...
    var closebutton = new kakao.maps.CustomOverlay({
    ...
    kakao.maps.event.addListener(closebutton, 'click', makeOutListener(map, closebutton, overlay));
