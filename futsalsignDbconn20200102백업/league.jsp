...
.select	{
	...
	.select:after	{right:7px; background-size:8px auto;}
	.select label	{height:36px; font-size:14px; line-height:36px}
	.select select	{height:36px; font-size:14px; line-height:36px}
	...
	/*리그 검색배너 이미지 및 검색 체크박스스타일*/
	#leaguesearchimg{
	float:left;height:68px;

	}
	#leagueyear{
	width:200px; height:40px; float:left;margin: 12px 20px;font-size:20px;
	}
	#leaguemonth{
	width:400px; height:40px;float:left;margin: 12px 20px;font-size:20px;
	}

	.teamrank{
			width:47%; height:416px;float:left;margin-top: 50px;
	}
	.playerrank{
			width:47%; height:416px;float:right;margin-top: 50px;
	}
	

	/*Team Rank 제목 바 h4 스타일*/
	
	.h_bar	{position:relative; padding-left:26px; color:#2c3c57; font-size:30px; line-height:40px; letter-spacing:-2px}
	.h_bar:before{content:""; display:block; position:absolute; top:5px; left:0; width:5px; height:30px; background:#2c3c57}
	.h_bar:after{content:""; display:block; position:absolute; top:5px; left:0; width:5px; height:6px; background:#aec8f4}
	...
	/*playerrank 스타일*/
	.cont{
	position:relative; margin-top:-1px; padding:4px; border:1px solid #d7d7d7; background:#fff}
	...
	<section id="main">
		...
		<table class="table table-striped">
			...
			<div class="text-center">
				...
				<div class="teamrank">
					<h4 class="h_bar"><strong>TEAM</strong> RANKING</h4>
					<div  class="rank">
						<table>
										...
										<tbody>
													...
													<tr>
														...
														<td>
															<div class="emb_wrap">
																<a href="team_info.asp?tcode=T1635"><span class="emb"><img src="/files/team/emblem_1635.jpg" alt=""></span> <span class="team">기흥FC</span></a>
															</div>
														</td>
														<td>23</td>
														<td>7</td>
													...
													<tr>
														...
														<td>
															<div class="emb_wrap">
																<a href="team_info.asp?tcode=T1653"><span class="emb"><img src="/images/content/default_team.png" alt=""></span> <span class="team">NTP FS</span></a>
															</div>
														</td>
														<td>23</td>
														<td>7</td>
													...
													<tr>
														...
														<td>
															<div class="emb_wrap">
																<a href="team_info.asp?tcode=T1602"><span class="emb"><img src="/files/team/emblem_1602.jpg" alt=""></span> <span class="team">P.K FC</span></a>
															</div>
														</td>
														<td>16</td>
														<td>5</td>
													...
													<tr>
														...
														<td>
															<div class="emb_wrap">
																<a href="team_info.asp?tcode=T1326"><span class="emb"><img src="/files/team/emblem_1326.PNG" alt=""></span> <span class="team">FC로이드</span></a>
															</div>
														</td>
														<td>12</td>
														<td>4</td>
													...
													<tr>
														...
														<td>
															<div class="emb_wrap">
																<a href="team_info.asp?tcode=T1553"><span class="emb"><img src="/files/team/emblem_1553.jpg" alt=""></span> <span class="team">FC BTC7</span></a>
															</div>
														</td>
														<td>7</td>
														<td>2</td>
													...
													<tr>
														...
														<td>
															<div class="emb_wrap">
																<a href="team_info.asp?tcode=T1627"><span class="emb"><img src="/files/team/emblem_1627.png" alt=""></span> <span class="team">FC이그니스</span></a>
															</div>
														</td>
														<td>6</td>
														<td>2</td>
				...
				<h4 class="h_bar"><strong>PLAYER</strong> RANKING</h4>
					<div class="player">
					<table>
										<caption>TEAM RANKING 테이블</caption>
										...
										<tbody>
													...
													<tr id="rankhead">
														<td ><img src="img/son.jpg" width=150px height=140px style="float:left"></td>
														<td>득점 1위 손흥민
														</td>
													</tr>
													<tr>
