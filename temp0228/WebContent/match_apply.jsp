...
<body>
	...
	<section id="main">
		<section id="mainright">
			<div id="matList">
				<h3
					class="h_tit" style="font-weight:normal;">매 치 신 청 </h3>
				<div class="cbox">
					<table class="table table-striped" style="font-size: 16px;">
						...
						<tbody>
							<input class="signbutton signbutton6 " type="button" value="매치등록"
								...
								onClick="location.href='match_apply_reg.jsp'">

							<%
								ArrayList<vo.MatchlistDto> match = ml.select();
							...
							<tr>
								<td class="thgongji"><%=match.get(i).getM_b_branch()%></td>

								<td class="thdate2" style="text-align: center;">
								
								
								<a
									onClick="selectOne(<%=match.get(i).getMno()%>,'<%=match.get(i).getMid()%>'); "
									class="button" id="listtt"> <%=match.get(i).getM_b_schedule()%></a></td>



								<td class="thdate2" style="text-align: center;"><%=match.get(i).getM_b_time()%></td>

								<td class="thname"><%=match.get(i).getM_b_name()%></td>


								<td class="thview"><%=match.get(i).getM_b_status()%></td>
							</tr>
