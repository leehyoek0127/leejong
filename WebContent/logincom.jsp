		...
		<section id="mainright">
			<div id="matList">
				<div class="container" id="formOutterWrapper">
					<h1 align=center>${id}'sMy page</h1>
					<div class="container" id="formInnerWrapper">
						<form name="join" id="materialForm" class="form" method="post" action="signInsert.jsp" role="form" autocomplete="off">
							...
							<div class="form-group">
								<div class="col-xs-2"></div>
								<div class="col-xs-2">
									<label class="labels active" for="hp1"> 휴대폰번호 </label> <input type="text" class="formInput" id="hp1" name="hp1" value="${hp1}" readonly>
								</div>
								<div class="col-xs-1" style="position: relative; top: -17px; right: -25px;">
									<h3>-</h3>
								</div>
								<div class="col-xs-2">
									<label class="labels active" for="hp2"></label> <input type="text" class="formInput" id="hp2" name="hp2" value="${hp2}" readonly>
								</div>
								<div class="col-xs-1" style="position: relative; top: -17px; right: -25px;">
									<h3>-</h3>
								</div>
								<div class="col-xs-2">
									<label class="labels active" for="hp3"></label> <input type="text" class="formInput" id="hp3" name="hp3" value="${hp3}" readonly>
								</div>
							</div>
							<div class="form-group">
								<div class="col-xs-2"></div>
								<div class="col-xs-3">
									<label class="labels active" for="em1"> 이메일 </label> <input type="text" class="formInput" id="em1" name="em1" value="${em1}" readonly>
								</div>
								<div class="col-xs-3">
									<input type="text" class="formInput" id="em2" name="em2" value="${em2}" readonly>
								</div>
							...
							<div class="form-group">
								<div class="col-xs-2"></div>
								<div class="col-xs-7">
									<label class="labels" for="hp"> 우편번호 </label> <input type="text" class="formInput" id="hp" name="hp">
								</div>
								<div class="col-xs-2">
							...
							<div class="form-group">
								<div class="col-xs-2"></div>
								<div class="col-xs-4">
									<label class="labels" for="adr1"> 기본주소 </label> <input type="text" class="formInput" id="adr1" name="adr1">
								</div>
								<div class="col-xs-4">
									<label class="labels" for="adr2"> 상세주소 </label> <input type="text" class="formInput" id="adr2" name="adr2">
								</div>
							</div>
							<div class="form-group">
								<div class="col-xs-2"></div>
							...
							<div class="form-group">
								...
								<div class="col-xs-6 radio">
									<div class="col-xs-3">
										<label> <input type="radio" name="team" id="team" value="teamok" checked> 있음
										</label>
									</div>
									<div class="col-xs-3">
										<label> <input type="radio" name="team" id="team" value="teamno"> 없음
										</label>
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-8 checkbox">
									<div class="col-xs-2">
										<label> <input type="checkbox" name=hobby value="FW"> FW
										</label>
									</div>
									<div class="col-xs-2">
										<label> <input type="checkbox" name=hobby value="MF"> MF
										</label>
									</div>
									<div class="col-xs-2">
										<label> <input type="checkbox" name=hobby value="DF"> DF
										</label>
									</div>
									<div class="col-xs-2">
										<label> <input type="checkbox" name=hobby value="GK"> GK
										</label>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="col-xs-8" style="font-size: 14px;"></div>
								<div class="col-xs-3">
									<input type="button" value="수정" class="signbutton signbutton5" onClick="joinsubmit()"> <input type="button" value="취소" class="signbutton signbuttoncancel" onClick="script: location.href='sign.jsp'">
								</div>
							</div>
