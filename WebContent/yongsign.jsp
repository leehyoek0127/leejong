	...
	function joinsubmit() {
		...
		if ((idlen < 8) || (idlen > 14)) {
			...
			alert("아이디 : " + join.id.value + "\n" + "비밀번호 : " + join.pw.value
					+ "\n" + "이름 : " + join.name.value + "\n" + "휴대폰번호 : "
					+ join.hp1.value + "-" + join.hp2.value + "-"
					+ join.hp3.value + "\n" + "이메일주소 : " + join.em1.value + "@"
					+ join.em2.value + "\n" + "생년월일 : " + join.yy.value + " 년 "
					+ join.mm.value + " 월 " + join.dd.value + "일\n")
		}
	}
</script>
<style>
		...
		<section id="mainright">
			<div id="matList">
				...
				<form name="join">
						...
						<tbody>
							...
							<tr>
								...
								<td class=ab>
									...
									- <input type="text" name="hp2" maxlength="4" class=box> - <input type="text" name="hp3" maxlength="4" class=box>
								</td>
							</tr>
							...
							<tr bgcolor=black align="center">
								<td colspan=2>
									<font color="white"> 매 치 정 보 </font>
								</td>
							</tr>

							<tr>
								<td class=ff>
									<font color="#FFCC33"> * </font> 지점 / 구장
								</td>
								<td class=ab>
									<select name="hp1" class=box>
										<option>지점1
							...
							<tr>
								...
								<td class=ab>
									...
									<input type="radio" name="gender" value="1" checked>여성<br> <input type="radio" name="gender" value="2">남성
					...
					<br> <input type="button" value="가입" class=fbtn onClick="joinsubmit()"> <input type="reset" value="초기화" class=fbtn>
				</form>
			</div>
