        ...
        <div class="container" id="formInnerWrapper">
                <form name = "ground" id="materialForm" class="form" method="post" action="groundinput.jsp" role="form" autocomplete="off">
                    <div class="form-group">
						...
						<div class="col-xs-8">
                            <label class="labels" for="place">풋살장위치</label>
                            <input type="text" class="formInput" id="place" name="place">
                        </div>
						<div class="col-xs-2">
                        </div>
					</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <label class="labels" for="placename">풋살장명칭</label>
                            <input type="text" class="formInput" id="placename" name="placename">		
                        </div>
						<div class="col-xs-2">     
                        </div>
					</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <label class="labels" for="placesize">구장크기</label>
                            <input type="text" class="formInput" id="placesize" name="placesize">
                        </div>
                        <div class="col-xs-2">
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <label class="labels" for="placeinfo">시설정보</label>
                            <input type="text" class="formInput" id="placeinfo" name="placeinfo">
                        </div>
						<div class="col-xs-2" >
					...
					<div class="form-group">
						...
						<div class="col-xs-3 groundtitle">
                            주차장여부
                        </div>
					...
					<div class="form-group">
						...
						<div class="col-xs-3">
                           <label>
						   <input type="radio" name="ball" value="Yes">Yes
						   </label>
                        </div>
						<div class="col-xs-3">
						<label>
                           <input type="radio" name="ball" value="No">No
						   </label>
                        </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-3">
                           <label>
						   <input type="radio" name="cloth" value="Yes">Yes
						   </label>
                        </div>
						<div class="col-xs-3">
						<label>
                           <input type="radio" name="cloth" value="No">No
						   </label>
                        </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-3">
                           <label>
						   <input type="radio" name="shoes" value="Yes">Yes
						   </label>
                        </div>
						<div class="col-xs-3">
						<label>
                           <input type="radio" name="shoes" value="No">No
						   </label>
                        </div>
						</div>
					</div>
